...
class SortedList:
    ...
    def count(self, key):
        ...
        while copy._binary_search(key) > -1:
            copy.pop(copy._binary_search(key))
            number += 1
    ...
    def intersection(self, rs):
        ...
        for i in range(0, len(self._values)):
            if rs._binary_search(self._values[i]) == -1 or new_list._binary_search(self._values[i]) == -1:
                new_list.insert(self._values[i])
        return new_list
    ...
    def union(self, rs):
        ...
        for i in range(0, len(self._values)):
            if new_list._binary_search(self._values[i]) == -1:
                new_list.insert(self._values[i])

        for i in range(0, len(rs._values)):
            if new_list._binary_search(rs._values[i]) == -1:
                new_list.insert(rs._values[i])
    ...
    def remove_many(self, key):
        ...
        while self._binary_search(key) > -1:
            self._values.pop(self._binary_search(key))
