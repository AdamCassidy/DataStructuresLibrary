...
""".format(i, Food.ORIGIN[i])
    ...
    def __init__(self, name, origin, is_vegetarian, calories):
        ...
        -------------------------------------------------------
        """
        assert origin in range(
            len(Food.ORIGIN)) or origin is None, "Invalid origin ID"
    ...
    def __str__(self):
        ...
        if self.origin is None:
            if self.calories is None:
                ...
                string = """Name:       {}
    Vegetarian: {}
    Calories:   {:,d}""".format(self.name, self.origin, self.is_vegetarian, self.calories)
